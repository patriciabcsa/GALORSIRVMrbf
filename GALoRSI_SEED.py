...
from logit_pvalue import logit_pvalue
...
dfData = dfData[dfData.label != 1] ###Neutral
...
allFeatures = dfData.drop(['label','percol'], axis=1)
...
def getHof():
	...
	numPop =10#100#100#50 #30 #100
	numGen =50#30#80#100#10
