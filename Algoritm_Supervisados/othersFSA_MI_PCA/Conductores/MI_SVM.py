...
plt.title('Confusion Matrix SVM MI')
plt.show()
...
plt.title('ROC curve SVM MI: AUC={0:0.3f}'.format(roc_auc_score(y_test,y_pred)))
plt.show()
...
plt.title('Lift curve SVM MI')
plt.show()


skplt.metrics.plot_ks_statistic(y_test, target_proba)
plt.title('KS curve SVM MI')
plt.show()
'''